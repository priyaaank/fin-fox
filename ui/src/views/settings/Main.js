    ...
    <React.Fragment>
      <Row>
        <Col sm={12}>
          <Card>
            <Card.Header>
              <Card.Title as="h5">App settings</Card.Title>
            </Card.Header>
            <Card.Body>
              <Row>
                <Col md={6}>
                  <Form>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                      ...
                      <Form.Text className="text-muted">Used for sending OTP and notifications</Form.Text>
                    </Form.Group>
                    
                    <Form.Group className="mb-3" controlId="formBasicPhone">
                      <Form.Label>Phone number</Form.Label>
                      <Form.Control type="phone" placeholder="Enter phone" />
                      <Form.Text className="text-muted">Used for sending OTP and notification</Form.Text>
                    </Form.Group>
